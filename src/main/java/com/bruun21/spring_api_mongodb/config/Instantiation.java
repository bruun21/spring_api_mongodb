...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sd.parse("21/03/2018"), "Partiu Viagem", "Vou viajara para São Paulo. Abraços!", maria);
		Post post2 = new Post(null, sd.parse("23/03/2018"), "Bom dia", "Acorde Feliz", maria);
